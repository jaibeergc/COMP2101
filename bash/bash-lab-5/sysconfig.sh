...
function error-message {
  echo "Some Error Occured while running script">&2
}
...
function error-exit {
  echo "Some error occured. Need to exit"
  exit
}
...
function displayhelp {
  ...
  echo "--host: Displays the host information"
  echo "--domain: Displays domain information"
  echo "--ipconfig: Displays ip information"
  echo "--os: Displays Operating System information"
...
function cleanup {
  echo "All temp files cleaned. Going to exit"
  rm /tmp/*.$$
  exit
}
